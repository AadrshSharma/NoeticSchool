...
created(){
  this.fetchData();
            ...
            this.country = this.page.country_id
            this.state = this.page.state_id
            this.city = this.page.city_id

        let arr = []
        if(this.page.skills0.length){
            this.page.skills0.forEach((a) => {
                arr.push(a.id);
            });
            this.multiselect_example = arr
        }
        else
            this.multiselect_example = arr
            // this.skills = this.page.skill
